function [ varargout ] = opMimuDynamicCAHRS_ArcTan( varargin )
%OPMIMUDYNAMICCAHRS_ARCTAN Wrapper function designed to process a dataset of
%accelerometer, gyroscope and magnetometer through CAHRS
%   [ quatsMIMU ] = ...
%   opMimuDynamicCAHRS_ArcTan( muAcc,muMag,samplingRate, AccGyrMag )
%
...
if ~isempty(boolDynamicMu)
    cahrs = CAHRS('fs',fs,'muAcc',0.5,'muMag',0.5);
